...
<body>
	<div class="container mt-5">
		...
		<a class="btn btn-success my-2" href="<?= base_url('index.php/file/add') ?>">Tambah</a>
		<table class="table table-hover" cellspacing='0' cellpadding='10' width='100%'>
			...
			<tbody>
				...
				<tr>
					...
					<td><?= $file->nama ?></td>
					<td>
						<a href="<?= base_url('index.php/file/edit/' . $file->id) ?>">Edit</a> |
						<a onclick="return confirm('Serius nih dihapus?')" href="<?= base_url('index.php/file/delete/' . $file->id) ?>">Hapus</a>
					</td>
				</tr>
				<?php endforeach; ?>
			</tbody>
